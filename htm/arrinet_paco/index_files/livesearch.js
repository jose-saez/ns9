...
function closeLiveSearch() {
	...
	document.getElementById("LSResult").style.display = "none";
	document.forms.searchform.searchword.value = 'buscar contenidos...';
}
...
function liveSearchProcessReqChange() {
	if (liveSearchReq.readyState == 4) {
		...
		res.firstChild.innerHTML = '</devel@bitflux.ch><div id="LSHeader">Teclas de flecha + Intro ; <a href="javascript://" title="Cerrar resultados" onclick="closeLiveSearch()">Cerrar (esc)</a><br /></div>'+liveSearchReq.responseText;//;
	}
}
...
var searchTerm = theText;
	...
	if (liveSearchReq.readyState == 4) {
		...
		newDiv.innerHTML = '<div id="liveLinkHead"><div style="float: left;">&nbsp;</div><div style="float: right;"><a href="javascript://" title="Cerrar resultados" onclick="closeLiveLink()">[x]</a></div><br></div>'+liveSearchReq.responseText;//;
